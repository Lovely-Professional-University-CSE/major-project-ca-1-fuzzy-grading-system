...
mte['l']=fuzz.trimf(mte.universe, [0,15,20])
mte['m']=fuzz.trimf(mte.universe,[20,25,30])
mte['h']=fuzz.trimf(mte.universe,[30,35,40])
ete['l']=fuzz.trimf(ete.universe,[0,20,35])
ete['m']=fuzz.trimf(ete.universe,[20,35,45])
ete['h']=fuzz.trimf(ete.universe,[45,55,70])
att['l']=fuzz.trimf(att.universe, [0,1,2])
att['m']=fuzz.trimf(att.universe, [2,3,4])
att['h']=fuzz.trimf(att.universe, [3,4,5])
grade['l']=fuzz.trimf(grade.universe,[0,2,4])
grade['m']=fuzz.trimf(grade.universe,[2,4,6])
...
wm.input['ete']=32
wm.input['att']=3
print(wm.output['grade'])ime.view(sim=wm)
