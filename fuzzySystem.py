...
ete.view()
cgpa.view()
rule1=ctrl.rule(mte['l'] | ete['l'] |attn['l'],grade['l'])
rule2=ctrl.rule(mte['m'] | ete['l'] |attn['l'],grade['l'])
rule3=ctrl.rule(mte['l'] | ete['m'] |attn['l'],grade['l'])
rule4=ctrl.rule(mte['l'] | ete['l'] |attn['m'],grade['l'])
rule5=ctrl.rule(mte['l'] | ete['l'] |attn['h'],grade['l'])
rule6=ctrl.rule(mte['l'] | ete['h'] |attn['l'],grade['m'])
rule7=ctrl.rule(mte['h'] | ete['l'] |attn['l'],grade['m'])
rule8=ctrl.rule(mte['l'] | ete['l'] |attn['h'],grade['l'])
rule9=ctrl.rule(mte['m'] | ete['m'] |attn['l'],grade['m'])
rule10=ctrl.rule(mte['m'] | ete['l'] |attn['m'],grade['l'])
rule11=ctrl.rule(mte['l'] | ete['m'] |attn['m'],grade['m'])
rule12=ctrl.rule(mte['m'] | ete['m'] |attn['m'],grade['m'])
rule13=ctrl.rule(mte['h'] | ete['h'] |attn['l'],grade['h'])
rule14=ctrl.rule(mte['h'] | ete['h'] |attn['h'],grade['h'])
rule15==ctrl.rule(mte['l'] | ete['h'] |attn['h'],grade['h'])
rule16==ctrl.rule(mte['h'] | ete['l'] |attn['h'],grade['m'])
